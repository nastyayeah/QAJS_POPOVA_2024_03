import { generateUserData } from '../book-store-fixture'

export const emptyBookRequestBody = {
  userId: '',
  collectionOfIsbns: [],
}

export const bookRequestBody = {
  userId: '',
  collectionOfIsbns: [
    {
      isbn: '9781449325862',
...
export const singleBookRequestBody = {
  userId: '',
  collectionOfIsbns: [
    {
      isbn: '9781593275846',
...
export const newISBN = '9781491904244'
